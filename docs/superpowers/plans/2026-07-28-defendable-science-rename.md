...
# the lockfile (regenerated by `uv lock`, never patched).
EXCLUDE_RE='^(honest-scholar/uv\.lock|docs/superpowers/specs/2026-07-28-defendable-science-rename-design\.md|docs/superpowers/plans/2026-07-28-defendable-science-rename\.md)$'
