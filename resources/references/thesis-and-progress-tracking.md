...
**Date:** 2026-07-17 · **For:** `defendable-science` sub-spec 1 (thesis level + `progress` skill). · **Status:** verified-source digest; migrates to the plugin's `resources/references/`.
