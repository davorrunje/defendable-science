...
**Date:** 2026-07-17 · **For:** `defendable-science` `literature` capability, `scout` mode (sub-spec 2). · **Status:** verified-source digest; migrates to the plugin's `resources/references/`.
