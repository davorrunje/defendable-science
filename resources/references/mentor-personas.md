...
**Date:** 2026-07-17 · **For:** `defendable-science` `defend` skill + the "advise as a mentor" voice (meta-spec §3.7, sub-spec 1). · **Status:** verified-source digest; migrates to the plugin's `resources/references/`.
