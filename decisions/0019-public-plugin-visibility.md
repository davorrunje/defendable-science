# ADR-0019: Public plugin, named `defendable-science`
...
- Sharp, science-only identity — `defendable-science` covers the science; engineering is
  delegated to a bound engineering backend via a contract.

## Considered options

1. **Public repo, named `defendable-science`.**
2. Private, shared only with colleagues/peers.
3. Decide visibility later.

## Decision

Option 1. Public, `defendable-science`.
